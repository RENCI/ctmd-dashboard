...
exports.list = (req, res) => {
    query = `SELECT CASE name.description WHEN 'Recruitment & Retention Plan' THEN 'Recruitment Plan' WHEN 'Single IRB' THEN 'Operationalize Single IRB' WHEN 'Standard Agreements' THEN 'Operationalize Standard Agreements' ELSE name.description END description FROM name WHERE "column"='serviceSelection' ORDER BY index;`
    db.any(query)
        .then(resources => {
